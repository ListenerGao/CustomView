 ...
 * @date 2019-04-19
 */
public class CustomViewFunctionAdapter extends BaseQuickAdapter<FunctionMode, BaseViewHolder> {

    public CustomViewFunctionAdapter(@Nullable List<FunctionMode> data) {
